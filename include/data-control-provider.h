 ...
 * @retval #DATACONTROL_ERROR_IO_ERROR          I/O error
 */
EXPORT_API int datacontrol_provider_send_data_changed_noti(
 ...
 * @retval #DATACONTROL_ERROR_IO_ERROR          I/O error
 */
EXPORT_API int datacontrol_provider_add_data_change_noti_consumer_filter_cb(
 ...
 * @retval #DATACONTROL_ERROR_IO_ERROR          I/O error
 */
EXPORT_API int datacontrol_provider_remove_data_change_noti_consumer_filter_cb(int callback_id);
 ...
 * @retval #DATACONTROL_ERROR_IO_ERROR          I/O error
 */
EXPORT_API int datacontrol_provider_foreach_data_changed_noti_consumer_list(
		datacontrol_h provider,
		void *list_cb,
		void *user_data);

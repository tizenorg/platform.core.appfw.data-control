 ...
 *
 * @return The bulk data bundle on success, otherwise NULL
...
/**
 * @brief  Gets nth bulk result from bulk result data handler.
 * @since_tizen 3.0
 * @privlevel   public
 *
 * @param [in]	result_data_h		Bulk result data handle
 * @param [in]	idx			Bulk result data index
 ...
 * @retval #DATA_CONTROL_ERROR_INVALID_PARAMETER Invalid parameter
 */
int data_control_bulk_result_data_get_result(data_control_bulk_result_data_h result_data_h, int idx, int *result);

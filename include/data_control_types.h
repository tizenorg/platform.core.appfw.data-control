...
typedef enum {
    ...
    DATA_CONTROL_NOTI_SQL_REGISTER_SUCCESS,
    DATA_CONTROL_NOTI_SQL_REGISTER_FAIL,
    DATA_CONTROL_NOTI_SQL_UNREGISTER_SUCCESS,
    DATA_CONTROL_NOTI_SQL_UNREGISTER_FAIL,
    DATA_CONTROL_NOTI_SQL_ENABLED,
    DATA_CONTROL_NOTI_SQL_DISABLED,
    DATA_CONTROL_NOTI_SQL_MAX
} data_control_sql_noti_type_e;
...
typedef enum {
    ...
    DATA_CONTROL_NOTI_MAP_REGISTER_SUCCESS,
    DATA_CONTROL_NOTI_MAP_REGISTER_FAIL,
    DATA_CONTROL_NOTI_MAP_UNREGISTER_SUCCESS,
    DATA_CONTROL_NOTI_MAP_UNREGISTER_FAIL,
    DATA_CONTROL_NOTI_MAP_ENABLED,
    DATA_CONTROL_NOTI_MAP_DISABLED,
    DATA_CONTROL_NOTI_MAP_MAX
} data_control_map_noti_type_e;

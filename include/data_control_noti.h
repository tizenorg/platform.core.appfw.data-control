 ...
 * data_control_provider_send_changed_notify() must be called to invoke this callback.
 *
 * @see  data_control_add_data_changed_cb()
 * @see	 data_control_provider_send_changed_notify()
 */
 ...
 * @details If the function is successful, data_control_add_data_changed_callback_result_cb() callback will be called.
 * @since_tizen 3.0
 * @privlevel   public
...
/**
* @} end group CAPI_DATA_CONTROL_CONSUMER_MODULE
*/

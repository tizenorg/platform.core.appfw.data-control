 ...
 * @see  data_control_provider_remove_data_change_noti_consumer_filter_cb()
 */
typedef bool (*data_control_provider_change_noti_consumer_filter_cb)(
		const data_control_h provider,
		const char *consumer_appid,
		const void *user_data);
 ...
 */
int data_control_provider_send_data_changed_noti(
 ...
 * @retval #DATA_CONTROL_ERROR_IO_ERROR          I/O error
 * @retval #DATA_CONTROL_ERROR_INVALID_PARAMETER Invalid parameter
 * @see  data_control_provider_change_noti_consumer_filter_cb()
 */
int data_control_provider_add_data_change_noti_consumer_filter_cb(
 ...
 * @retval #DATA_CONTROL_ERROR_INVALID_PARAMETER Invalid parameter
 */
int data_control_provider_remove_data_change_noti_consumer_filter_cb(int callback_id);

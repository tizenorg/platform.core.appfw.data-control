 ...
 *
 * @pre  data_control_provider_get_changed_noti_consumer_list() must be called to invoke this callback.
 * @see  data_control_provider_get_changed_noti_consumer_list()
 */

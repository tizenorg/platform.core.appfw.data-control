...
/**
 * @brief  Called when the application call data_control_provider_foreach_changed_noti_consumer_list.
 * @since_tizen 3.0
 *
 ...
 *
 * @pre  data_control_provider_foreach_changed_noti_consumer_list() must be called to invoke this callback.
 * @see  data_control_provider_foreach_changed_noti_consumer_list()
 */
 ...
 * @remarks If it returns false, it means provider deny conusmer_appid application to add data changed callback.
...
/**
 * @brief  Sends data changed notification to consumer apps which are successfully add data changed callback.
 ...
 * @retval #DATA_CONTROL_ERROR_PERMISSION_DENIED Permission denied
 *
 * @pre  If consumer want to receive notification, data_control_data_changed_cb() should be added by consumer.
...
/**
 * @brief  Adds consumer filter for add data changed callback process.
 * @since_tizen 3.0
 * @remarks If provider do not call this API, all add data changed callback requests will be allowed.
 * @remarks If at least one added data_control_provider_changed_noti_consumer_filter_cb return false for the consumer, \n
 *                           provider do not add that consumer to notification target consumer list.
 *
...
/**
 * @brief  Removes consumer filter for add data changed callback process.
 * @since_tizen 3.0
 *
...
/**
 * @brief  Retrieves all provider's notification target consumer id.
 * @since_tizen 3.0
 ...
 */
int data_control_provider_foreach_changed_noti_consumer_list(
		data_control_h provider,

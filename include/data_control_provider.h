 ...
 * @param[in]  bulk_data  	The information about insert rows \n
 ...
 * @param[in]  request_id	The request ID
 * @param[in]  provider		The provider handle
 * @param[in]  bulk_data	The information about key-value pairs \n
 * @param[in]  user_data	The user data passed from the register function
 */
...
typedef struct {
	...
	data_control_provider_map_bulk_add_value_request_cb bulk_add_cb; /**< This callback function is called when a request for bulk add is received from other application. */
...
/**
 * @brief  Sends the success result of the bulk insert request to the client application.
 * @since_tizen 2.3
 *
 * @param[in]  request_id		The request ID

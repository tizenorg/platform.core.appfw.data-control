...
int datacontrol_provider_send_data_changed_noti(
...
int datacontrol_provider_add_data_change_noti_consumer_filter_cb(
		data_control_provider_change_noti_consumer_filter_cb callback,
		void *user_data,
		int *callback_id)
{
...
int datacontrol_provider_remove_data_change_noti_consumer_filter_cb(int callback_id)
{
	GList *find_list;
	changed_noti_consumer_filter_info_s filter_info;
	filter_info.callback_id = callback_id;
...
int datacontrol_provider_foreach_data_changed_noti_consumer_list(
		datacontrol_h provider,
		void *list_cb,
		void *user_data)
{

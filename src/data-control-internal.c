...
{
	datacontrol_noti_type_e ret_type = DATACONTROL_NOTI_SQL_UPDATE;
	switch (type) {
...
{
	data_control_noti_type_e ret_type = DATA_CONTROL_NOTI_SQL_UPDATE;
	switch(type) {
	case DATACONTROL_NOTI_SQL_UPDATE:
		ret_type = DATA_CONTROL_NOTI_SQL_UPDATE;
		break;
	case DATACONTROL_NOTI_SQL_INSERT:
		ret_type = DATA_CONTROL_NOTI_SQL_INSERT;
		break;
	case DATACONTROL_NOTI_SQL_DELETE:
		ret_type = DATA_CONTROL_NOTI_SQL_DELETE;
		break;
	case DATACONTROL_NOTI_MAP_SET:
		ret_type = DATA_CONTROL_NOTI_MAP_SET;
		break;
	case DATACONTROL_NOTI_MAP_ADD:
		ret_type = DATA_CONTROL_NOTI_MAP_ADD;
		break;
	case DATACONTROL_NOTI_MAP_REMOVE:
		ret_type = DATA_CONTROL_NOTI_MAP_REMOVE;
		break;
	default:
		LOGE("Invalid noti type");
		break;
...
char *_get_encoded_db_path(char *consumer_appid)
{
	...
	encoded_appid = g_compute_checksum_for_string(G_CHECKSUM_MD5, consumer_appid, -1);

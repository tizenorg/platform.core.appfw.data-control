	...
	bundle *data)
{
	...
	return datacontrol_provider_send_changed_notify(provider, NOTI_MAP_CMD_STRING[type], data);
}
	...
	bundle *data)
{
	...
	return datacontrol_provider_send_changed_notify(provider, NOTI_SQL_CMD_STRING[type], data);
}

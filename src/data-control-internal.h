...
int _read_socket_pair(int fd, char *buffer, unsigned int nbytes, unsigned int *bytes_read);
int _write_socket_pair(int fd, void *buffer, unsigned int nbytes, unsigned int *bytes_write);
